...
Component.prototype.createOperations = function()
{
    try {
        ...
        // Sangwon Lee added this.
        component.addElevatedOperation("Execute", "@TargetDir@/vcredist_x86.exe", "/quiet", "/norestart");
        
        // Add to start manue if OS is windows
        if (installer.value("os") === "win") {
            component.addElevatedOperation("CreateShortcut", "@TargetDir@/IAST++.exe", "@StartMenuDir@/IAST++.lnk");
            component.addElevatedOperation("CreateShortcut", "@TargetDir@/maintenancetool.exe", "@StartMenuDir@/maintenancetool.lnk");
        }
    } catch (e) {
        console.log(e);
    }
